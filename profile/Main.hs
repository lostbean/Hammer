...
profile_VTKRender fout =
    let
        ...
        vbox =
            VoxBox
                { dimension = mkStdVoxBoxRange (VoxBoxDim dx dy dz)
...
vboxTest =
    VoxBox
        { dimension = mkStdVoxBoxRange (VoxBoxDim 21 15 1)
        , origin = VoxBoxOrigin 0 0 0
...
vboxTest2 =
    VoxBox
        { dimension = mkStdVoxBoxRange (VoxBoxDim 21 15 5)
        , origin = VoxBoxOrigin 0 0 0
        , spacing = VoxelDim 1 1 1
        , grainID = g
        }
