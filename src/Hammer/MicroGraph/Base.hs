...
insertVertexConn vid es (mgp@MicroGraph{..}) =
    let
...
insertEdgeConn eid fs (mgp@MicroGraph{..}) =
    let
...
insertFaceConn fid (mgp@MicroGraph{..}) =
    let
        mg = insertSubLevelAutoConn fid generateSubLevelConn microGrains
        generateSubLevelConn f =
            let
                (a, b) = unFaceID f
             in
                [mkGrainID a, mkGrainID b]
     in
        mgp{microGrains = mg}
...
insertVertexProp ::
    ...
    MicroGraph g f e v ->
    MicroGraph g f e v
insertVertexProp func vid v (mgp@MicroGraph{..}) =
    let
...
insertEdgeProp ::
    ...
    MicroGraph g f e v ->
    MicroGraph g f e v
insertEdgeProp func eid v (mgp@MicroGraph{..}) =
    let
...
insertFaceProp ::
    ...
    MicroGraph g f e v ->
    MicroGraph g f e v
insertFaceProp func fid v (mgp@MicroGraph{..}) =
    let
...
insertGrainProp ::
    ...
    MicroGraph g f e v ->
    MicroGraph g f e v
insertGrainProp func gid v (mgp@MicroGraph{..}) =
    let
...
insertNewVertex vid vp es (mgp@MicroGraph{..}) =
    let
     ...
     in
        mgp{microEdges = me, microVertex = mv}

insertNewEdge :: EdgeID -> e -> [FaceID] -> MicroGraph g f e v -> MicroGraph g f e v
insertNewEdge eid ep fs (mgp@MicroGraph{..}) =
    let
     ...
     in
        mgp{microFaces = mf, microEdges = me}

insertNewFace :: FaceID -> f -> MicroGraph g f e v -> MicroGraph g f e v
insertNewFace fid fp (mgp@MicroGraph{..}) =
    let
